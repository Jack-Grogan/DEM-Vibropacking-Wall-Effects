...
df = pd.read_csv(r"final_voxel_packing_restitution_results_batch.csv")
df.rename({'Unnamed: 0': 'restitution_pw'}, axis=1, inplace=True)
df_restitution_pw = np.asarray(df['restitution_pw'])
...
repeats_s0_r0 = [0]*len(df_restitution_pw)
repeats_s1_r0 = [0]*len(df_restitution_pw)
repeats_s0_r1 = [0]*len(df_restitution_pw)
repeats_s1_r1 = [0]*len(df_restitution_pw)

for i in range(len(df_restitution_pw)):
...
p1, = plt.plot(df_restitution_pw, mean_s0_r0, color = colors[0], linewidth = 0.7)
f1 = plt.fill_between(df_restitution_pw, top_line_s0_r0, bottom_line_s0_r0, color=colors[0], alpha=.2)#, label = '1 Standard Deviation')
   
p2, = plt.plot(df_restitution_pw, mean_s1_r0, color = colors[1], linewidth = 0.7)
f2 = plt.fill_between(df_restitution_pw, top_line_s1_r0, bottom_line_s1_r0, color=colors[1], alpha=.2)#, label = '1 Standard Deviation')

p3, = plt.plot(df_restitution_pw, mean_s0_r1, color = colors[2], linewidth = 0.7)
f3 = plt.fill_between(df_restitution_pw, top_line_s0_r1, bottom_line_s0_r1, color=colors[2], alpha=.2)#, label = '1 Standard Deviation')

p4, = plt.plot(df_restitution_pw, mean_s1_r1, color = colors[3], linewidth = 0.7)
f4 = plt.fill_between(df_restitution_pw, top_line_s1_r1, bottom_line_s1_r1, color=colors[3], alpha=.2)#, label = '1 Standard Deviation')
...
plt.minorticks_on()
plt.xlabel("Particle-Wall Restitution Coefficient (-)", fontsize = 11.5)
...
plt.savefig('method_3_procedure_2_restitution_graph', bbox_inches="tight")