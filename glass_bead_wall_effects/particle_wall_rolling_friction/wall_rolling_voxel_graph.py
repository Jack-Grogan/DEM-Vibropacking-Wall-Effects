...
df = pd.read_csv(r"final_voxel_packing_rolling_results_wide.csv")
...
df2 = pd.read_csv(r"final_voxel_packing_rolling_results.csv")
...
xy1a = (0,y_lims[0])
xy2a = (autoAxis2[0],y_lims[1])

xy1b = (0.6,y_lims[0])
xy2b = (autoAxis2[1],y_lims[1])
...
plt.savefig('wall_rolling_voxel_graph_box', bbox_inches="tight")