...
ax.set_xlabel('Particle-Wall Coefficient of Restitution (-)', fontsize = 11.5)
ax.set_ylabel('Final Packing Density (-)', fontsize = 11.5)
ax.tick_params(axis = 'both', labelsize = 11.5)
ax.set_ylim(0.600, 0.619)


plt.savefig('wall_restitution_voxel_graph_box', bbox_inches="tight")