...
for seed in seeds:
    ...
    study_directory = os.path.join(f"{particle_diameter:.0f}_mm_diameter_particles", "continuous", f"seed_{seed}")
...
glob_input = os.path.join(f"{particle_diameter:.0f}_mm_diameter_particles", "continuous", "seed_*")
