...
with open(os.path.join("template_periodic", "base_template.geo"), 'r') as f:
    base_template = f.read()

with open(os.path.join("template_periodic", "inface_template.geo"), 'r') as f:
    inface_template = f.read()

with open(os.path.join("template_periodic", "shake_template.sim"), 'r') as f:
    simulation_template = f.read()

with open(os.path.join("template_periodic", "batch_launch_template.sh"), 'r') as f:
...
for seed in seeds:
    ...
    study_directory = os.path.join(f"{particle_diameter:.0f}_mm_diameter_particles", "periodic", f"seed_{seed}")
...
glob_input = os.path.join(f"{particle_diameter:.0f}_mm_diameter_particles", "periodic", "seed_*")
