...
data2 = data["periodic"]
data3 = data["batch_periodic"]
data4 = data["batch_continuous"]
...
for ax in bax.axs:
    ax.set_xticks(tick_positions_x, ["Method 1", "Method 2"], fontsize = 16)
    ax.yaxis.grid(True)
...
fill_operation =  ("Method 3", "Method 4")
...
ax.set_xlim([0.7, 2.7])
ax.set_xticks(tick_positions_x_2, fill_operation, fontsize = 16)
ax.yaxis.grid(True)
